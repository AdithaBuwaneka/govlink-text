// src/components/agent/dashboard/DashboardLayout.tsx
"use client";
...
// Beautiful Detailed Lotus Flower with Original Pink/Red Colors
...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ 
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden theme-transition-slow">
      {/* EXACT SAME Background as Landing Page and Login */}
