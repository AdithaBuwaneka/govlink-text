      ...
      <div className="glass-morphism max-w-2xl w-full max-h-[90vh] overflow-y-auto rounded-2xl border border-border/50 shadow-glow">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="p-4 bg-card/20 rounded-xl">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-r from-[#FFC72C] to-[#FF5722] rounded-full flex items-center justify-center text-white font-bold text-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {Object.entries(t.resolutionOptions).map(([value, label]) => (
                <button
                  ...
                  disabled={isEnding}
                  className={`p-3 border-2 rounded-xl text-sm font-medium transition-all duration-300 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed ${
                    resolution === value 
        ...
        <div className="flex justify-end gap-3 p-6 border-t border-border/30">
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-[#FF5722] to-[#8D153A] text-white rounded-xl hover:from-[#8D153A] hover:to-[#FF5722] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {isEnding && (
