      ...
      <div className="glass-morphism max-w-md w-full rounded-2xl border border-border/50 shadow-glow">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border/30">
          ...
          <button
            ...
            className="p-2 rounded-xl bg-card/30 border border-border/50 text-foreground hover:bg-card/50 transition-all duration-300 disabled:opacity-50"
          >
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <select
              ...
              disabled={isTransferring}
              className="w-full py-3 px-4 bg-card/30 border border-border/50 rounded-xl text-foreground focus:outline-none focus:border-[#FFC72C] transition-all duration-300 disabled:opacity-50"
            >
          ...
          <div>
            ...
            <textarea
              ...
              disabled={isTransferring}
              className="w-full py-3 px-4 bg-card/30 border border-border/50 rounded-xl text-foreground placeholder-muted-foreground focus:outline-none focus:border-[#FFC72C] transition-all duration-300 resize-none disabled:opacity-50"
              rows={3}
            />
          </div>
          ...
          {/* Transfer Status */}
          {isTransferring && (
            <div className="flex items-center justify-center gap-3 p-4 bg-[#008060]/10 border border-[#008060]/30 rounded-xl">
        ...
        <div className="flex justify-end gap-3 p-6 border-t border-border/30">
          <button
            onClick={handleCancel}
            disabled={isTransferring}
            className="px-6 py-3 bg-card/30 border border-border/50 rounded-xl text-foreground hover:bg-card/50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {t.cancel}
          </button>
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-[#008060] to-[#FFC72C] text-white rounded-xl hover:from-[#FFC72C] hover:to-[#FF5722] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {isTransferring && (
