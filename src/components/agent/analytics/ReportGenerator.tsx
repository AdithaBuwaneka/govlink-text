...
const ReportGenerator: React.FC<ReportGeneratorProps> = ({ language = 'en' }) => {
  ...
  const inputStyles = "w-full bg-card/30 border border-border/50 rounded-xl px-4 py-3 text-foreground focus:outline-none focus:border-[#FFC72C] transition-all duration-300";
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Tab Navigation */}
      <div className="glass-morphism p-2 rounded-2xl border border-border/50">
        <div className="flex">
          <button
      ...
      {activeTab === 'quick' && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="group bg-card/30 border border-border/50 rounded-xl p-6 hover:bg-card/50 transition-all duration-300 cursor-pointer"
                 onClick={() => handleQuickReport()}>
              <div className="flex items-center gap-4 mb-4">
                <div className="p-3 bg-gradient-to-r from-[#FFC72C]/10 to-[#FF5722]/10 rounded-xl group-hover:scale-110 transition-transform">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FFC72C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div>
                  <h4 className="font-semibold text-foreground group-hover:text-[#FFC72C] transition-colors">
              ...
              <button
                ...
                className="w-full px-4 py-2 bg-gradient-to-r from-[#FFC72C] to-[#FF5722] text-white rounded-lg hover:from-[#FF5722] hover:to-[#8D153A] transition-all duration-300 disabled:opacity-50"
              >
            ...
            <div className="group bg-card/30 border border-border/50 rounded-xl p-6 hover:bg-card/50 transition-all duration-300 cursor-pointer"
                 onClick={() => handleQuickReport()}>
              <div className="flex items-center gap-4 mb-4">
                <div className="p-3 bg-gradient-to-r from-[#008060]/10 to-[#FFC72C]/10 rounded-xl group-hover:scale-110 transition-transform">
                ...
                <div>
                  <h4 className="font-semibold text-foreground group-hover:text-[#008060] transition-colors">
                    {t.serviceTemplate}
                  </h4>
                  <p className="text-sm text-muted-foreground">Service usage analysis</p>
                </div>
              </div>
              <button
                disabled={isGenerating}
                className="w-full px-4 py-2 bg-gradient-to-r from-[#008060] to-[#FFC72C] text-white rounded-lg hover:from-[#FFC72C] hover:to-[#FF5722] transition-all duration-300 disabled:opacity-50"
              >
                {isGenerating ? t.generating : t.generateNow}
              </button>
            </div>
            ...
            <div className="group bg-card/30 border border-border/50 rounded-xl p-6 hover:bg-card/50 transition-all duration-300 cursor-pointer"
                 onClick={() => handleQuickReport()}>
              <div className="flex items-center gap-4 mb-4">
                <div className="p-3 bg-gradient-to-r from-[#FF5722]/10 to-[#8D153A]/10 rounded-xl group-hover:scale-110 transition-transform">
                ...
                <div>
                  <h4 className="font-semibold text-foreground group-hover:text-[#FF5722] transition-colors">
                    {t.operationalTemplate}
                  </h4>
                  <p className="text-sm text-muted-foreground">Operational summary</p>
                </div>
              </div>
              <button
                disabled={isGenerating}
                className="w-full px-4 py-2 bg-gradient-to-r from-[#FF5722] to-[#8D153A] text-white rounded-lg hover:from-[#8D153A] hover:to-[#FF5722] transition-all duration-300 disabled:opacity-50"
              >
                {isGenerating ? t.generating : t.generateNow}
              </button>
            </div>
          ...
          <form onSubmit={(e) => { e.preventDefault(); handleGenerateReport(); }} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <label key={key} className="flex items-center justify-between p-3 bg-card/30 border border-border/50 rounded-xl cursor-pointer hover:bg-card/50 transition-all duration-300">
            ...
            <div className="flex flex-wrap gap-4 justify-end pt-6 border-t border-border/30">
              ...
              <button
                type="submit"
                disabled={isGenerating}
                className="px-8 py-3 bg-gradient-to-r from-[#FFC72C] to-[#FF5722] text-white rounded-xl hover:from-[#FF5722] hover:to-[#8D153A] transition-all duration-300 font-semibold hover:scale-105 disabled:opacity-50 disabled:hover:scale-100"
              >
                {isGenerating ? (
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            {recentReports.map((report) => (
              <div key={report.id} className="flex items-center justify-between p-6 bg-card/30 border border-border/50 rounded-xl hover:bg-card/50 transition-all duration-300">
                ...
                <div className="flex items-center gap-3">
                  <button className="p-2 bg-[#008060]/10 text-[#008060] rounded-lg hover:bg-[#008060]/20 transition-all duration-300">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <button className="p-2 bg-[#FFC72C]/10 text-[#FFC72C] rounded-lg hover:bg-[#FFC72C]/20 transition-all duration-300">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
                      <circle cx="12" cy="12" r="3"/>
                    </svg>
                  </button>
                  <button className="p-2 bg-[#FF5722]/10 text-[#FF5722] rounded-lg hover:bg-[#FF5722]/20 transition-all duration-300">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
