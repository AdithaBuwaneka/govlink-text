...
const trendsTranslations: Record<Language, TrendsTranslation> = {
  ...
  ta: {
    ...
    updateProcesses: 'கைமுறை பணிभारத்தை குறைக்க தானியங்கு செயல்முறைகளை புதுப்பிக்கவும்',
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button className="px-4 py-2 bg-card/30 border border-border/50 rounded-xl text-foreground hover:bg-card/50 transition-all duration-300 text-sm">
            {t.exportData}
          </button>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4">
          {peakHoursData.sort((a, b) => b.traffic - a.traffic).map((hour) => (
            <div key={hour.hour} className="text-center">
              ...
              <div className="text-sm font-medium text-foreground">{hour.hour}</div>
        ...
        <div className="bg-card/30 border border-border/50 rounded-xl p-6">
          ...
          <div className="space-y-4">
            {bottlenecksData.map((bottleneck) => (
              <div key={bottleneck.id} className="p-4 bg-card/50 rounded-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {resourceData.map((resource) => (
            <div key={resource.name} className="text-center">
              ...
              <div className="font-medium text-foreground mb-1">{resource.name}</div>
      ...
      <div className="bg-gradient-to-r from-[#008060]/10 to-[#FFC72C]/10 border border-[#008060]/30 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start gap-3 p-3 bg-card/30 rounded-xl">
