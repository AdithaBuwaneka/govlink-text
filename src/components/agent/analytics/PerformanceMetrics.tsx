        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {personalMetricKeys.map((key) => {
              ...
              return (
              <div key={key} className="bg-card/30 border border-border/50 rounded-xl p-4">
          ...
          <div className="bg-card/30 border border-border/50 rounded-xl p-6">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-[#008060]/10 to-[#FFC72C]/10 border border-[#008060]/30 rounded-xl">
              ...
              {teamRankingData.map((agent) => (
                <div 
                  ...
                  className={`flex items-center justify-between p-4 rounded-xl transition-all duration-300 ${
                    agent.isCurrentUser 
                      ? 'bg-gradient-to-r from-[#FFC72C]/20 to-[#FF5722]/20 border border-[#FFC72C]/30' 
