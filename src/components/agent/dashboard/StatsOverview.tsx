    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
      {stats.map((stat, index) => (
        <div 
          key={stat.id} 
          className={`
            group glass-morphism p-6 rounded-2xl border border-border/50 shadow-glow transition-all duration-500 hover:shadow-2xl hover:scale-105 animate-fade-in-up
          `}
        ...
        >
          ...
          <div className="flex items-center justify-between mb-4">
            <div 
              className={`
                p-3 rounded-xl bg-gradient-to-r ${stat.bgColor} transition-all duration-300 group-hover:scale-110
              `}
            >
          ...
          <div className="mb-2">
            <div 
              className="text-3xl sm:text-4xl font-bold transition-colors duration-300 group-hover:scale-105" 
