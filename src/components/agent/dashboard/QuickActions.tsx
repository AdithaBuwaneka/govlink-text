...
const QuickActions: React.FC<QuickActionsProps> = ({ language = 'en' }) => {
  ...
  return (
    <section className="animate-fade-in-up" style={{animationDelay: '0.4s'}}>
      {/* Section Header */}
      <div className="mb-8">
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#008060]/20 to-[#FFC72C]/20 px-4 py-2 rounded-full border border-[#008060]/30 mb-4">
          <span className="w-2 h-2 bg-gradient-to-r from-[#008060] to-[#FFC72C] rounded-full animate-pulse"></span>
          <span className="text-sm font-medium text-[#008060]">{t.quickActions}</span>
        </div>
      </div>
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Quick Stats Card */}
        <div className="glass-morphism p-6 rounded-2xl border border-border/50 shadow-glow animate-fade-in-up" style={{animationDelay: '0.5s'}}>
          <div className="flex items-center gap-4">
            <div className="p-3 bg-gradient-to-r from-[#FFC72C]/10 to-[#FF5722]/10 rounded-xl">
            ...
            <div>
              <div className="text-lg font-semibold text-foreground">Quick Stats</div>
        ...
        <div className="glass-morphism p-6 rounded-2xl border border-border/50 shadow-glow animate-fade-in-up" style={{animationDelay: '0.6s'}}>
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="text-lg font-semibold text-foreground">Department</div>
        ...
        {/* System Health Card */}
        <div className="glass-morphism p-6 rounded-2xl border border-border/50 shadow-glow animate-fade-in-up" style={{animationDelay: '0.7s'}}>
          <div className="flex items-center gap-4">
            <div className="p-3 bg-gradient-to-r from-[#008060]/10 to-[#008060]/5 rounded-xl">
              <div className="w-3 h-3 bg-[#008060] rounded-full animate-pulse"></div>
            </div>
            <div>
              <div className="text-lg font-semibold text-foreground">System Status</div>
