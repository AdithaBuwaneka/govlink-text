  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 animate-fade-in-up">
        <div className="flex items-center gap-2 bg-gradient-to-r from-[#FFC72C]/20 to-[#FF5722]/20 px-4 py-2 rounded-full border border-[#FFC72C]/30">
        ...
        <div className="flex flex-wrap items-center gap-3">
          {/* Time Range Selector */}
          <div className="flex bg-card/30 border border-border/50 rounded-xl p-1">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-card/30 border border-border/50 rounded-xl text-foreground hover:bg-card/50 transition-all duration-300 hover:scale-105 disabled:opacity-50"
          >
            <svg 
              width="16" 
              height="16" 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in-up" style={{animationDelay: '0.1s'}}>
        {quickStats.map((stat, index) => (
          <div 
            key={stat.id}
            className="group glass-morphism p-6 rounded-2xl border border-border/50 shadow-glow transition-all duration-500 hover:shadow-2xl hover:scale-105 animate-fade-in-up"
            style={{animationDelay: `${0.1 * (index + 1)}s`}}
          >
            <div className="flex items-center justify-between mb-4">
              <div 
                className="p-3 rounded-xl bg-gradient-to-r from-transparent to-transparent transition-all duration-300 group-hover:scale-110"
            ...
            <div className="mb-2">
              <div 
                className="text-3xl font-bold transition-colors duration-300 group-hover:scale-105" 
      ...
      {/* Tab Navigation */}
      <div className="glass-morphism p-2 rounded-2xl border border-border/50 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
        <div className="flex">
          <button
